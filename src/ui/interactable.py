...
class InteractableSlider(QWidget):
    ...
    def __init__(self, main_window, label: str, min_max_values: tuple[int], display_type=None):
        super().__init__()
        self.setFixedSize(100, 110)  # Set a fixed size for better rendering
        ...
        self.slider.setFixedWidth(self.width() - 10)
        ...
        self.display.setFixedSize(self.width(), 20)
    ...
    def slider_changed(self, value):
        ...
        res = str(value * c) + "%" if self.display_type in {"decimal-percentage", "percentage"} else str(value * c)
